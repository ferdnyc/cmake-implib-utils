...
Currently there is only one public API call here:
  ...
  fix_implib(TARGET target [PACKAGE_NAME package] [PATHS dir1 ...])
...
# Function:
# fix_implib(TARGET target [PACKAGE_NAME package] [PATHS paths])
#
# (Win32 only)
...
macro(fix_implib)
  ...
  cmake_parse_arguments(FindImpLib
    "${options}"
    "${oneValueArgs}"
    "${multiValueArgs}"
    ${ARGN}
  ...
  if(DEFINED FindImpLib_PATHS)
    set(_search_paths "${FindImpLib_PATHS}")
  else()
    set(_search_paths)
  endif()
